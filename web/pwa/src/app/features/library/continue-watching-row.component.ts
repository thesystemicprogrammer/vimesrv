      ...
      <div class="mb-8">
        ...
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-xl font-bold text-white">
            {{ 'library.continueWatching' | translate }}
          </h2>
        </div>
              ...
              <div class="flex-shrink-0 w-48 sm:w-56 md:w-64 snap-start">
                ...
                >
                  ...
                  >
                    ...
                    <div
                      class="absolute bottom-0 left-0 right-0 h-1 bg-slate-800/90"
                    >
                      <div
                  ...
                  <div class="p-3">
                    ...
                    <div class="mt-1 text-xs text-slate-400">
                      @if (item.media_type === 'episode' && item.series_name) {
                        ...
                        <div class="mt-0.5">
                          S{{ formatSeasonEpisode(item.season_number) }}E{{
                            formatSeasonEpisode(item.episode_number)
                          }}
