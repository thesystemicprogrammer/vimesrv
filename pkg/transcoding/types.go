// Package transcoding provides shared video transcoding functionality
// that can be used by both the main server and remote worker binaries.
package transcoding
...
// Progress represents the current progress of a transcoding operation
